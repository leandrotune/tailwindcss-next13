...
export function TabItem({ value, title, isSelected = false }: TabItemProps) {
  return (
    <Tabs.Trigger
      className="group relative px-1 pb-4 text-sm font-medium text-zinc-500 outline-none hover:text-violet-300 data-[state=active]:text-violet-700  dark:text-zinc-400 dark:data-[state-active]:text-violet-300"
      value={value}
    >
